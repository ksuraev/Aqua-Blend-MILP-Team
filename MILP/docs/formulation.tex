...
\end{equation}
The load leaving the plant is what remains after the final process, $\ell^{n_{tp}}_{tp}$.
...
\begin{enumerate}[label=(\roman*), align=left, widest=viii]
    ...
    \item Treatment only reduces a load, lower limits met by blending alone.
