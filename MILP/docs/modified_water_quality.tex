...
We highlight here that, according to \cite{who2004water}, removal process can only reduce alkalinity, though it can be increased by an adjustment process.
...
\begin{enumerate}[label=(\roman*), align=left, widest=viii]
    ...
    \item A removal process $r_i \in \mathcal R_{tp}$ can remove more than one $p \in \mathcal P$.
